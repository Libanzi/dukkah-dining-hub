...
const staff = [
  ...
  {
    img: "/photos/team-6.png",
    imgPosition: "center 10%",
    name: "[Name TBC]",
    role: "Floor Staff",
    bio: "The warmth you feel the moment you walk in starts with our floor team. Attentive, knowledgeable, and genuinely passionate about making every visit memorable.",
    tags: ["Table Service", "African Hospitality", "Fine Dining"],
  },
  {
    img: "/photos/team-7.png",
    imgPosition: "center 15%",
    name: "[Name TBC]",
    role: "Floor Manager",
